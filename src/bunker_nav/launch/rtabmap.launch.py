...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('scan_cloud_assembling',      default_value='false'),
        DeclareLaunchArgument('assembling_time',      default_value='1.0'),
        DeclareLaunchArgument('max_clouds',      default_value='0'),
        ...
        DeclareLaunchArgument('range_max',      default_value='0.0'),
        DeclareLaunchArgument('noise_radius',      default_value='0.0'),
        DeclareLaunchArgument('noise_min_neighbors',      default_value='5'),
        ...
        Node(
            ...
            condition=IfCondition(PythonExpression(["'", LaunchConfiguration('scan_cloud_assembling'), "' == 'true' and '", LaunchConfiguration('subscribe_scan_cloud'), "' == 'true'"])),
            parameters=[{
                "frame_id": LaunchConfiguration('frame_id'),
                "odom_frame_id": LaunchConfiguration('vo_frame_id'),
                "assembling_time": LaunchConfiguration('assembling_time'),
                "max_clouds": LaunchConfiguration('max_clouds'),
                "fixed_frame_id": LaunchConfiguration('fixed_frame_id'),
                "voxel_size": LaunchConfiguration('voxel_size'),
                "range_min": LaunchConfiguration('range_min'),
                "range_max": LaunchConfiguration('range_max'),
                "noise_radius": LaunchConfiguration('noise_radius'),
                "approx_sync": LaunchConfiguration('approx_sync'),
                "approx_sync_max_interval": LaunchConfiguration('approx_sync_max_interval'),
                "noise_min_neighbors": LaunchConfiguration('noise_min_neighbors')}],
            remappings=[
                ("cloud", LaunchConfiguration('scan_cloud_topic')),
        ...
        Node(
            ...
            parameters=[{
                ...
                # "Grid/Sensor":'1.0', #1.0 to use rgbd point cloud
            }],
            remappings=[
                ("rgb/image", LaunchConfiguration('rgb_topic_relay')),
                ("depth/image", LaunchConfiguration('depth_topic_relay')),
