...
def generate_launch_description():
    ...
    rtabmap_launch = PathJoinSubstitution(
        [FindPackageShare("bunker_nav"),
        "launch",
        "rtabmap_launch_for_kinect.launch.py"],
    )
    ...
    rtbamap_sim = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'rgb_topic': '/semantic/rgb/image_raw',
            'depth_topic': '/semantic/depth_to_rgb/image_raw',
            'camera_info_topic': '/semantic/camera_info',
