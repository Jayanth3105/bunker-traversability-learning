#
# This file is to be replaced in foxy system rtabmap launch file to prevent crashing of rtabmap after 20 loops
# 
#
    ...
    return [
        ...
        Node(
            ...
            parameters=[{
                ...
                "map_always_update": LaunchConfiguration('subscribe_depth'),
                "map_empty_ray_tracing": LaunchConfiguration('subscribe_depth'),
                # "tf_tolerance": LaunchConfiguration('wait_for_transform'),
                # "map_negative_poses_ignored": LaunchConfiguration('subscribe_depth'),
